...
#setwd("C:/Users/zshang/Documents/GitHub/shiny-server/ui/")
#dir<-getwd()
#testData <- read.csv(paste0(dir,"/data.csv"))

#testData <- read.csv("C:/Users/zshang/Documents/GitHub/shiny-server/ui/data.csv")
#testData <- read.csv("data.csv")
testData <- read.csv("/srv/shiny-server/ui/data.csv")
#dir<-getwd()
#testData <- read.csv(paste0(dir,"/data.csv"))
